...
import { getMatchesForUser } from "@/lib/api"
...
export default function GameArchivePage() {
  ...
  useEffect(() => {
    async function fetchMatches() {
      ...
      setError(null)
      try {
        const matchesRes = await getMatchesForUser(defaultUser)
        const formattedMatches = (matchesRes || []).map((match: any) => {
          const isPlayer1 = match.challenger.username === defaultUser
          return {
            id: match._id,
            ...
            rating1Before: match.challenger.rating, // You can enhance if you store rating history
            rating1After: match.challenger.rating,  // You can enhance if you store rating history
  ...
  return (
    <div className="min-h-screen p-4">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">My Game Archive</h1>
      </div>
